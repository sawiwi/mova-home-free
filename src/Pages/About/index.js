...
const About = () =>{
    return(
        <section className=" xl:max-w-[1200px] mx-auto p-10" id="aboutMe">
            <div className="">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3">
                ...
                <img
                    ...
                    alt="about-img"
                    className="rounded-full  h-[200px] w-[200px] mt-10 mx-22 md:mx-2 xl:w-[210px] xl:h-[210px] xl:mt-28 xl:mx-14"
                    />
                </div>
                <div className="grid col-span-1">
                    <p className="mt-8 xl:mt-20">Somos un equipo comprometido con el crecimiento de nuestros asociados, con quienes trabajamos de forma colaborativa, adaptándonos permanentemente a sus exigencias y a los cambios del mercado inmobiliario.
