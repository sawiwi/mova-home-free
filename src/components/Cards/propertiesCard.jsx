...
const PropertiesCard = ({ item, valueUf }) => {
  ...
  const _renderItem = (name,code,price) => {
    ...
    return (`UF: ${parseToDecimal(ufValue)}`)
  };
      ...
      <div className='mb-6'>
        <a href='#propiedad' className=''>
          <div className='relative bg-gray-200 overflow-hidden'>
            <center>
              <img src={item.image} className='h-[255px] w-auto hover:scale-110 transition-transform duration-300' alt=''/>
            </center>
        ...
        <div className='shadow-xl'>
          ...
          <div className='p-6 pt-3'>
            <h5 className='hover:text-primary-default text-black mb-2'>
              <a href='#propiedad'>
                <p className='text-primary-default mb-2'>Codigo: {item.id}</p>
                {item.title}
              </a>
            </h5>
