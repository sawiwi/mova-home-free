...
const ListCard = ({item, valueUf}) => {
  ...
  const _renderItem = (name,code,price) => {
    ...
    return (
      <div className='w-full'>
        <p className='flex justify-center md:justify-end items-center mb-3 font-semibold text-xl border-primary-400 p-1 rounded-sm text-primary-default'>
          UF: {parseToDecimal(ufValue)}
        </p>
        <p className='flex justify-center md:justify-end items-center mb-3 font-semibold text-xl border-primary-400 p-1 rounded-sm text-black'>
  ...
  return (
    <div className='flex border border-gray-300 my-4 rounded-xl hover:shadow-xl transition-shadow duration-300 flex-col md:flex-row'>
      <div className='md:w-1/3 flex justify-center relative bg-gray-200'>
        <img src={item.image} className='h-[300px] w-auto' alt=''/>
        ...
        <div className='md:w-2/3 flex flex-col justify-center p-3'>
          <div className='flex flex-col w-full text-[#A6ADBB]'>
            <small className='flex mb-3'>
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-xl mr-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 14c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4zm0-6c1.103 0 2 .897 2 2s-.897 2-2 2-2-.897-2-2 .897-2 2-2z"></path><path d="M11.42 21.814a.998.998 0 0 0 1.16 0C12.884 21.599 20.029 16.44 20 10c0-4.411-3.589-8-8-8S4 5.589 4 9.995c-.029 6.445 7.116 11.604 7.42 11.819zM12 4c3.309 0 6 2.691 6 6.005.021 4.438-4.388 8.423-6 9.73-1.611-1.308-6.021-5.294-6-9.735 0-3.309 2.691-6 6-6z"></path></svg>
              {item.address}
            </small>
            <small className='text-primary-default'>COD: {item.id}</small>
          </div>
                ...
                <tr className='[&>td>div>svg]:text-primary-default text-[#A6ADBB]'>
                  <td>
                    <div className='flex items-center justify-center'>
                      ...
                      <span className='ml-1'>{item.surface_m2}</span>
                    </div>
                  </td>
                  <td>
                    <div className='flex items-center justify-center'>
                      ...
                      <span className='ml-1'>{item.bedrooms}</span>
                    </div>
                  </td>
                  <td>
                    <div className='flex items-center justify-center'>
                      ...
                      <span className='ml-1'>{item.bathrooms}</span>
                    </div>
                  </td>
                  <td>
                    <div className='flex items-center justify-center'>
                      ...
                      <span className='ml-1'>{item.coveredParkingLots}</span>
                    </div>
                  </td>
                </tr>
              </tbody>
